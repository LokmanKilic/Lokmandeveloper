...
//=================================== TURKCE DERS =========================================================================================
    ...
    /* İ (trigger.isBefore&&trigger.isUpdate) {

     for (account  acc: trigger.new) {

        if (acc.Name !=trigger.oldMap.get(acc.Id).Name) {
            
            acc.description=' Bu recordun ismi değişti';
        }
...
/* 
//1 Account create edildiğinde. ona bağlı 7 tane Contact otomatik olarak create edilsin. 
first name'i account name ile aynı olsun. last name i contact 1 2 3.. diye isimlendirilsin..
